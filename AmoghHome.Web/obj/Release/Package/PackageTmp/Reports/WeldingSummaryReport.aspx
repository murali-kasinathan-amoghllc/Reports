<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeldingSummaryReport.aspx.cs" Inherits="AmoghHome.Web.Views.Home.WeldingSummaryReport" %>
                ...
                <div class="headerInfo">
                    ...
                    <form runat="server" id="form">
                        <div class="form-row align-items-center">
                            <div class="col-auto">
                                <input type="text" id="weldNumber" runat="server" class="form-control mb-2" placeholder="Weld Report No">
                            </div>
                            <div class="col-auto">
