<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpoolClearanceAndReleaseReport.aspx.cs" Inherits="AmoghHome.Web.Views.Home.SpoolClearanceAndReleaseReport" %>
                ...
                <div class="headerInfo">
                    ...
                    <form runat="server" id="form">
                        <div class="form-row align-items-center">
                            <div class="col-auto">
                                <input type="text" id="spoolNumber" runat="server" class="form-control mb-2" placeholder="Spool Number">
                            </div>
                            <div class="col-auto">
