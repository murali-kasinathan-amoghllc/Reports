...
{
    /// <summary>
    /// Summary description for SpoolGenProgress_LotWise_Exclude3RevService
    /// </summary>
    [WebService(Namespace = "http://maakuthari.com/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    [System.Web.Script.Services.ScriptService]
    public class SpoolGenProgress_LotWise_Exclude3RevService : System.Web.Services.WebService
    {

        [WebMethod]
        [ScriptMethod(UseHttpGet = true, ResponseFormat = ResponseFormat.Json)]
        public void GetSpoolGenExclude3RevisionStatusDetails(int ProjId)
        {
            ...
            {
                conn.Open();
                string sql = "SELECT * FROM VIEW_ISOME_REP_C_EXCLUDE3" +
