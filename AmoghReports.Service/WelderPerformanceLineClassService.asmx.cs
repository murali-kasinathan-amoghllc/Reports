...
{
    /// <summary>
    /// Summary description for WelderPerformanceLineClassService
    /// </summary>
    [WebService(Namespace = "http://maakuthari.com/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    [System.Web.Script.Services.ScriptService]
    public class WelderPerformanceLineClassService : System.Web.Services.WebService
    {

        [WebMethod]
        [ScriptMethod(UseHttpGet = true, ResponseFormat = ResponseFormat.Json)]
        public void GetWelderPerformanceLineClassDetails(int ProjId, int SUB_CON_ID, string DATE_FROM, string DATE_TO)
        {
            ...
            using (OracleConnection conn = new OracleConnection(conn_str))
            {
                ...
                string sql = "SELECT PROJECT_ID, JOB_CODE, CLIENT_NAME, JOB_NAME, PROJ_DESC, " +
                      ...
                      $"SUM(FNC_IIF_DATE(CREATE_DATE, TO_DATE('{DATE_FROM}') -7, 0, REP_JNTS, 0)) AS JNTS_REPAR_PREV, LINE_CLASS FROM VIEW_WELDER_PERF_F_NEW " +
                      ...
                      $"ORDER BY SUB_CON_NAME, WELDER_NO,LINE_CLASS,REP_TITLE1, REP_TITLE2";
        ...
        [WebMethod]
        [ScriptMethod(UseHttpGet = true, ResponseFormat = ResponseFormat.Json)]
        public void GetWelderPerformanceLineClassDetailsPDF(int ProjId, int SUB_CON_ID, string DATE_FROM, string DATE_TO)
        {
            Random random = new Random();
            int fileId = random.Next(1000, 9999);
            string fileName = $"WelderPerformanceLineClass_{fileId}.pdf";
