<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Magnetic_ParticleTestingReport.aspx.cs" Inherits="AmoghReports.WebSite.Reports.Magnetic_ParticleTestingReport" %>
         ...
         <div class="form-style-2">
                    <form runat="server" id="form" method="post">
                        ...
                        <div class="form-row align-items-center">
                            <label for="field1"><span>NDE ReportNo <span class="required">*</span></span><input type="text" id="mt_NDE_ReportNo" runat="server" class="input-field" name="field1" value="" /></label>
