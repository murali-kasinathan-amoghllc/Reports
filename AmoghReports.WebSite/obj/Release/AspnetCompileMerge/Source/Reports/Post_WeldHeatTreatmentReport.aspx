<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Post_WeldHeatTreatmentReport.aspx.cs" Inherits="AmoghReports.WebSite.Reports.Post_WeldHeatTreatmentReport" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnReports").click(function () {
                ...
                var ndeNo = $("#pwht_NDE_ReportNo").val();
         ...
         <div class="form-style-2">
                    <form runat="server" id="form" method="post">
                        ...
                        <div class="form-row align-items-center">
                            <label for="field1"><span>NDE ReportNo <span class="required">*</span></span><input type="text" id="pwht_NDE_ReportNo" runat="server" class="input-field" name="field1" value="" /></label>
