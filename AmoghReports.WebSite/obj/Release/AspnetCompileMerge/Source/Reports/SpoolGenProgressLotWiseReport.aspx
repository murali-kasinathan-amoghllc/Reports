<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpoolGenProgressLotWiseReport.aspx.cs" Inherits="AmoghReports.WebSite.Reports.SpoolGenProgressLotWiseReport" %>
     ...
     <div class="">
                <span class="">
                    <img src="Images/master-header.png" alt="Image" style="height: 70px" />
                            <span class="lo-image">
                                SPOOLGEN STATUS REPORT (LOT WISE)
                            </span>
                </span>
                <hr />
