<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpoolClearanceAndReleaseReport.aspx.cs" Inherits="AmoghReports.WebSite.Reports.SpoolClearanceAndReleaseReport" %>
     ...
     <div class="">
                <span class="">
                    <img src="Images/master-header.png" alt="Image" style="height: 70px" />
                            <span class="lo-image">
                                SPOOL CLEARANCE AND RELEASE REPORT 
                            </span>
                </span>
                <hr />
         <div class="form-style-2">
                    <form runat="server" id="form" method="post">
                        ...
                        <div class="form-row align-items-center">
                            <label for="field1"><span>Spool Number <span class="required">*</span></span><input type="text" id="spoolNumber" runat="server" class="input-field" name="field1" value="" /></label>
